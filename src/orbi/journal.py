...
JOURNAL_EVENTS: dict[str, str] = {
    ...
    "release_ticket_created": "an idle tick created a release Issue for a finished Milestone",
    "release_ticket_create_skipped": "idle auto-create skipped (ticket exists, or version_file unknown)",
    "release_ticket_create_failed": "idle auto-create of a release Issue failed (bypass)",
