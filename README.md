...
Want just the CLI? It is not on PyPI yet ([Issue #852](https://github.com/orbi-build/orbi/issues/852)); the one-line installer at the top of [Getting started](docs/getting-started.mdx) is the shortest supported install.
